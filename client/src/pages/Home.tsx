...
import { ArrowDown, ArrowRight, ArrowUpRight, Check, ChevronDown, Instagram, Linkedin, Menu, MessageCircle, Play, Plus, Send, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="soft-site">
      ...
      {menuOpen && <nav className="mobile-nav"><a href="#about" onClick={() => setMenuOpen(false)}>About</a><a href="#capabilities" onClick={() => setMenuOpen(false)}>Capabilities</a><a href="#process" onClick={() => setMenuOpen(false)}>Process</a><a href="#enquiry" onClick={() => setMenuOpen(false)}>Enquire</a></nav>}
